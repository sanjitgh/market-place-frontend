                    ...
                    <tr key={job._id}>
                        ...
                        <div className="flex items-center gap-x-2">
                          <p
                            className={`px-3 py-1 ${
                              ...
                              job.category === "Graphics Design" && "bg-red-100"
                            } 
                            } ${
                              job.category === "Digital Marketing" && "bg-purple-100"
                            } 
                      ...
                      <td className="px-4 py-4 text-sm whitespace-nowrap">
                        <div className="flex items-center gap-x-6">
                          <button
                            onClick={() => handelToastDelete(job._id)}
